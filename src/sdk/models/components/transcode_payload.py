...
class TranscodePayloadType(str, Enum):
...
class TranscodePayload2:
    ...
    type: TranscodePayloadType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of service. This is optional and defaults to `url` if
    ŚURL field is provided.
    """
...
class TranscodePayloadSchemasStorageType(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TranscodePayloadSchemasCredentials:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TranscodePayloadSchemas2:
    r"""Storage for the output files"""
    credentials: TranscodePayloadSchemasCredentials = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials') }})
    r"""Delegation proof for Livepeer to be able to upload to
    web3.storage
    """
    type: TranscodePayloadSchemasStorageType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of service used for output files"""
    


class TranscodePayloadSchemasType(str, Enum):
    r"""Type of service used for output files"""
    S3 = 's3'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TranscodePayloadCredentials:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TranscodePayloadSchemas1:
    r"""Storage for the output files"""
    bucket: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bucket') }})
    r"""Bucket with output files"""
    credentials: TranscodePayloadCredentials = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials') }})
    r"""Credentials for the output video storage"""
    endpoint: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('endpoint') }})
    r"""Service endpoint URL (AWS S3 endpoint list: https://docs.aws.amazon.com/general/latest/gr/s3.html, GCP S3 endpoint: https://storage.googleapis.com, Storj: https://gateway.storjshare.io)"""
    type: TranscodePayloadSchemasType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of service used for output files"""
...
class TranscodePayload:
    input: Union[TranscodePayload1, TranscodePayload2] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('input') }})
    outputs: Outputs = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('outputs') }})
    r"""Output formats"""
    storage: Union[TranscodePayloadSchemas1, TranscodePayloadSchemas2] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('storage') }})
