...
with Livepeer(
    ...
    res = livepeer.session.get_clips(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.session.get(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.session.get_recorded(parent_id="<value>", record=True)
