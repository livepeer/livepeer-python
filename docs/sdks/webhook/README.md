...
with Livepeer(
    ...
    res = livepeer.webhook.create(request={
        "name": "test_webhook",
...
with Livepeer(
    ...
    res = livepeer.webhook.get(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.webhook.update(id="<id>", webhook={
        "name": "test_webhook",
        "url": "https://my-service.com/webhook",
        "project_id": "aac12556-4d65-4d34-9fb6-d1f0985eb0a9",
        "events": [
...
with Livepeer(
    ...
    res = livepeer.webhook.delete(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.webhook.get_logs(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.webhook.get_log(id="<id>", log_id="<value>")
...
with Livepeer(
    ...
    res = livepeer.webhook.resend_log(id="<id>", log_id="<value>")
