...
with Livepeer(
    ...
    res = livepeer.stream.update(id="<id>", stream_patch_payload={
        "record": False,
        "multistream": {
            "targets": [
                {
...
with Livepeer(
    ...
    res = livepeer.stream.delete(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.stream.terminate(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.stream.start_pull(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.stream.create_clip(request={
...
with Livepeer(
    ...
    res = livepeer.stream.get_clips(id="<id>")
...
with Livepeer(
    ...
    res = livepeer.stream.add_multistream_target(id="<id>", target_add_payload={
        "profile": "720p0",
        "video_only": False,
        "id": "PUSH123",
        "spec": {
...
with Livepeer(
    ...
    res = livepeer.stream.remove_multistream_target(id="<id>", target_id="<value>")
