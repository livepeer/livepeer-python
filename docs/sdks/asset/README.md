...
with Livepeer(
    ...
    res = livepeer.asset.create(request={
        "name": "filename.mp4",
        "static_mp4": True,
        "playback_policy": {
...
with Livepeer(
    ...
    res = livepeer.asset.create_via_url(request={
        "name": "filename.mp4",
...
with Livepeer(
    ...
    res = livepeer.asset.get(asset_id="<value>")
...
with Livepeer(
    ...
    res = livepeer.asset.update(asset_id="<value>", asset_patch_payload={
        "name": "filename.mp4",
        "playback_policy": {
            "type": components.Type.WEBHOOK,
            "webhook_id": "1bde4o2i6xycudoy",
...
with Livepeer(
    ...
    res = livepeer.asset.delete(asset_id="<value>")
