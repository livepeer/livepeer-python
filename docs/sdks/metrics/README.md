...
with Livepeer(
    ...
    res = livepeer.metrics.get_realtime_viewership()
...
with Livepeer(
    ...
    res = livepeer.metrics.get_viewership(request={})
...
with Livepeer(
    ...
    res = livepeer.metrics.get_creator_viewership(request={})
...
with Livepeer(
    ...
    res = livepeer.metrics.get_public_viewership(playback_id="<value>")
...
with Livepeer(
    ...
    res = livepeer.metrics.get_usage(request={})
